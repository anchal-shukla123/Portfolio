...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:${personalInfo.emails.primary}?subject=Hiring Inquiry - Portfolio&body=Hello ${personalInfo.firstName},%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ABest Regards,`;
